...
rm -f src/config/keymaker-config.h
...
rm -rf test_bitcoin.coverage/ keymaker-gtest.coverage/ total.coverage/
...
clean_exe src/bench/bench_keymaker
clean_exe src/keymaker-cli
clean_exe src/keymakerd
clean_exe src/keymaker-gtest
clean_exe src/test/test_keymaker
clean_exe src/test/test_keymaker_fuzzy
clean_exe src/qt/keymaker-qt
clean_exe src/qt/test/test_keymaker-qt
...
clean_dep . src/config/keymaker-config.h.in
