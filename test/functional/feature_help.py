...
"""Verify that starting keymakerd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start keymakerd with -h for help text")
        ...
        self.log.info("Start keymakerd with -version for version information")
        ...
        self.log.info("Start keymakerd with -fakearg  to make sure it does not start")
