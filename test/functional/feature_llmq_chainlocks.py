...
from test_framework.test_framework import KeymakerTestFramework
...
class LLMQChainLocksTest(KeymakerTestFramework):
    def set_test_params(self):
        self.set_keymaker_test_params(6, 5, fast_dip3_enforcement=True)
