...
Below are some notes on how to build Keymaker Core for Windows.

The options known to work for building Keymaker Core on Windows are:

* On Linux, using the [Mingw-w64](https://www.mingw-w64.org/) cross compiler tool chain. 
and is the platform used to build the Keymaker Core Windows release binaries.
...
way. This will install to `c:\workspace\keymaker`, for example:

    make install DESTDIR=/mnt/c/workspace/keymaker
