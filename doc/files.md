...
* keymakerd.pid: stores the process id of keymakerd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by keymakerd or keymaker-qt
