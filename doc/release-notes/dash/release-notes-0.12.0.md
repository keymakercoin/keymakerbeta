...
Keymaker Core version 0.12.0 is now available from:

  https://keymaker.io/downloads
...
backwards-compatible with pre-0.12 versions of Keymaker Core or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/keymaker/).
