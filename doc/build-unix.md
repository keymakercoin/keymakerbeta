...
-----------------------
Building the dependencies and Keymaker Core requires some essential build tools and libraries to be installed before.
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, Keymaker Core should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, Keymaker Core may be compiled in
