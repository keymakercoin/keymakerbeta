...
This mechanism has been integrated into Bitcore-Node-Keymaker which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/raptor3um/insight-api-keymaker#web-socket-api](https://github.com/raptor3um/insight-api-keymaker#web-socket-api)
* API: [https://github.com/raptor3um/insight-api-keymaker#instantsend-transactions](https://github.com/raptor3um/insight-api-keymaker#instantsend-transactions)
