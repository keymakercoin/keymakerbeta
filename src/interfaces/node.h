...
//! Interface for the src/evo part of a keymaker node (keymakerd process).
    class EVO {
    public:
        virtual ~EVO() {}
...
//! Interface for the src/llmq part of a keymaker node (keymakerd process).
    class LLMQ {
    public:
        virtual ~LLMQ() {}
...
//! Interface for the src/smartnode part of a keymaker node (keymakerd process).
    namespace Smartnode {
        class Sync {
        public:
            virtual ~Sync() {}
...
//! Top-level interface for a keymaker node (keymakerd process).
    class Node {
    public:
        virtual ~Node() {}
