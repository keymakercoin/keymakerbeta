...
static UniValue validateaddress(const JSONRPCRequest &request) {
    RPCHelpMan{"validateaddress",
               ...
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Keymaker address to validate"},
               },
               RPCResult{
                       RPCResult::Type::OBJ, "", "",
                       {
    ...
    RPCHelpMan{"verifymessage",
               "\nVerify a signed message\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The Keymaker address to use for the signature."},
...
UniValue getaddressutxos(const JSONRPCRequest &request) {
    RPCHelpMan{
            ...
            "\nReturns all unspent outputs for an address (requires addressindex to be enabled).\n",
            {
                ...
                {"asset", RPCArg::Type::STR, /* default */ "KEYM", "Get UTXOs for a particular asset instead of KEYM ('*' for all assets).",}
            },
            {
                RPCResult{"For KEYM",
                    RPCResult::Type::ARR, "", "",
...
UniValue getaddressdeltas(const JSONRPCRequest &request) {
    RPCHelpMan{"getaddressdeltas",
               "\nReturns all changes for an address (requires addressindex to be enabled).\n",
               {
                    ...
                    {"asset", RPCArg::Type::STR, /* default */ "KEYM", "Get all changes for a particular asset instead of KEYM.",}
...
static UniValue getaddressbalance(const JSONRPCRequest &request) {
    RPCHelpMan{"getaddressbalance",
               "\nReturns the balance for an address(es) (requires addressindex to be enabled).\n",
        {
            ...
            {"asset", RPCArg::Type::STR, /* default */ "KEYM", "Get balance for a particular asset instead of KEYM. (\"*\" for all assets)"},
        },
        {
            RPCResult{"For KEYM",
                RPCResult::Type::OBJ, "", "",
...
UniValue logging(const JSONRPCRequest &request) {
    RPCHelpMan{"logging",
               ...
               "The valid logging categories are: " + LogInstance().LogCategoriesString() + "\n"
                                                                                            ...
                                                                                            "  - \"keymaker\" activates all Keymaker-specific categories at once.\n"
...
static const CRPCCommand commands[] =
        { //  category              name                      actor (function)         argNames
                ...
                /* Keymaker features */
                {"keymaker",    "mnsync",                 &mnsync,                 {}},
                {"keymaker",    "spork",                  &spork,                  {"arg0",       "value"}},
