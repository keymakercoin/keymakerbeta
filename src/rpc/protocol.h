...
enum RPCErrorCode {
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in keymakerd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,  //!< Keymaker is not connected
