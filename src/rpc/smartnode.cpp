...
static void smartnode_list_help(const JSONRPCRequest &request) {
    RPCHelpMan{"smartnodelist",
               ...
               "  owneraddress   - Print the smartnode owner Keymaker address\n"
               "  payee          - Print the smartnode payout Keymaker address (can be additionally filtered,\n"
               "                   partial match)\n"
               "  pubKeyOperator - Print the smartnode operator public key\n"
               "  status         - Print smartnode status: ENABLED / POSE_BANNED\n"
               "                   (can be additionally filtered, partial match)\n"
               "  votingaddress  - Print the smartnode voting Keymaker address\n",
               {
...
static const CRPCCommand commands[] =
        { //  category              name                      actor (function)         argNames
                //  --------------------- ------------------------  -----------------------  ----------
                {"keymaker", "smartnode",     &smartnode, {}},
                {"keymaker", "smartnodelist", &smartnode, {}},
        };
