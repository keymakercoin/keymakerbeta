                                ...
                                {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                                 {
                                         {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO,
                                          "A key-value pair. The key (string) is the Keymaker address, the value (float or string) is the amount in " +
                                          CURRENCY_UNIT},
                                 },
                                },
    ...
    RPCHelpMan{"decodescript",
               ...
               RPCResult{
                       RPCResult::Type::OBJ, "", "",
                       {
                               ...
                               {RPCResult::Type::ARR, "addresses", "",
                                {
                                        {RPCResult::Type::STR, "address", "Keymaker address"},
                                }},
