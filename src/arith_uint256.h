...
#ifndef KEYMAKER_ARITH_UINT256_H
#define KEYMAKER_ARITH_UINT256_H
...
public:
     ...
     *
     * Keymaker only uses this "compact" format for encoding difficulty
...
#endif // KEYMAKER_ARITH_UINT256_H
