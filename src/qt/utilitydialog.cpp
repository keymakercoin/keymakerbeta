...
HelpMessageDialog::HelpMessageDialog(interfaces::Node &node, QWidget *parent, HelpMode helpMode) :
    ...
    if (helpMode == about) {
        ...
        QString header = "Usage: keymaker-qt [command-line options]                     \n";
...
All the Keymaker in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 KEYM, 0.01 KEYM, 0.1 KEYM, 1 KEYM and 10 KEYM -- sort of like the paper money you use every day.</li> \
