...
/* KeymakerGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* KeymakerGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_DOMAIN "keymaker.com"
#define QAPP_APP_NAME_DEFAULT "Keymaker-Qt"
#define QAPP_APP_NAME_TESTNET "Keymaker-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Keymaker-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Keymaker-Qt-regtest"
