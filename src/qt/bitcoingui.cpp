...
void BitcoinGUI::createActions() {
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a Keymaker address"));
    ...
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a Keymaker address").arg(strCoinJoinName));
    coinJoinCoinsMenuAction->setToolTip(coinJoinCoinsMenuAction->statusTip());

    receiveCoinsMenuAction = new QAction(tr(" Receive"), this);
    receiveCoinsMenuAction->setStatusTip(tr("Request payments (generates QR codes and keymaker: URIs)"));
    receiveCoinsMenuAction->setToolTip(receiveCoinsMenuAction->statusTip());

    sendAssetsMenuAction = new QAction(tr(" Send Asset"), this);
    sendAssetsMenuAction->setStatusTip(tr("Send assets to a Keymaker address"));
    ...
    verifyMessageAction->setStatusTip(
            tr("Verify messages to ensure they were signed with specified Keymaker addresses"));
    ...
    openAction->setStatusTip(tr("Open a keymaker: URI"));
    ...
    showHelpMessageAction->setStatusTip(
            tr("Show the %1 help message to get a list with possible Keymaker command-line options").arg(
                    PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState() {
    ...
    if (fNetworkActive) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Keymaker network", "", count));
    } else {
