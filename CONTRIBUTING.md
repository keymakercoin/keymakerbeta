Contributing to Keymaker Core
============================

The Keymaker Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/keymakercoin/keymaker/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Keymaker Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Keymaker
Network Protocol consensus changes.

Whether a pull request is merged into Keymaker Core rests with the project merge
...
Patches that change Keymaker consensus rules are considerably more involved than
...
Where a patch set proposes to change the Keymaker consensus, it must have been
...
The review process is normally fairly responsive on the Keymaker Core repository, however
...
The project leader is the release manager for each Keymaker Core release.
